...
| LEWIS-003 | As a user, I want my schedule data to persist so that I don't have to re-enter courses every time. | 10 | 5 | N | In Progress | Teju |
| LEWIS-004 | As a developer, I want to set up Firebase Firestore so that we can store user schedule data. | 9 | 3 | Y | In Progress | Fernando |
...
| LEWIS-020 | As a developer, I want to connect the front end to Firebase API so that schedule data loads dynamically. | 8 | 5 | Y | In Progress | Teju |
