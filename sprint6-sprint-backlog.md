...
| LEWIS-003 | As a user, I want my schedule data to persist so that I don't have to re-enter courses every time. | 10 | 5 | N | Teju |
| LEWIS-004 | As a developer, I want to set up Firebase Firestore so that we can store user schedule data. | 9 | 3 | Y | Fernando |
| LEWIS-005 | As a developer, I want to generate an ICS feed from stored schedule data so that users can subscribe to live calendar updates. | 9 | 5 | Y | Leland |
